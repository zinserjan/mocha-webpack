...
stat('lib', function(error, stat) {
  if (error || !stat.isDirectory()) {
    console.warn(
      '-'.repeat(79) + '\n' +
      'Built output not found. It looks like you might be attempting to install mocha-webpack\n' +
      'from GitHub. Sources need to be transpiled before use. We\n' +
    ...
    try {
      ...
      console.error(
        '-'.repeat(79) + '\n' +
        'Failed to build mocha-webpack automatically. Please install mocha-webpack from\n' +
